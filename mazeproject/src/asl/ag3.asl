...
/* Plans */
+!explore : at(X,Y,goal3) <- pickup(X,Y); !returnToStart.

+!explore : left(X,Y,goal3) <- move(X,Y); !explore.
+!explore : right(X,Y,goal3) <- move(X,Y); !explore.
+!explore : top(X,Y,goal3) <- move(X,Y); !explore.
+!explore : down(X,Y,goal3) <- move(X,Y); !explore.
...
+left(X,Y,ag0) : seenGoal(X2,Y2, goal0) & not givenPathToGoal(goal0) <- .send(ag0,unachieve,explore); .send(ag0, tell, getPathFrom(ag3)).
+right(X,Y,ag0) : seenGoal(X2,Y2, goal0) & not givenPathToGoal(goal0) <-.send(ag0,unachieve,explore); .send(ag0, tell, getPathFrom(ag3)).
+top(X,Y,ag0) : seenGoal(X2,Y2, goal0) & not givenPathToGoal(goal0) <- .send(ag0,unachieve,explore); .send(ag0, tell, getPathFrom(ag3)).
+down(X,Y,ag0) : seenGoal(X2,Y2, goal0) & not givenPathToGoal(goal0) <- .send(ag0,unachieve,explore); .send(ag0, tell, getPathFrom(ag3)).

+left(X,Y,ag1) : seenGoal(X2,Y2, goal1) & not givenPathToGoal(goal1) <- .send(ag1,unachieve,explore); .send(ag1, tell, getPathFrom(ag3)).
+right(X,Y,ag1) : seenGoal(X2,Y2, goal1) & not givenPathToGoal(goal1) <-.send(ag1,unachieve,explore); .send(ag1, tell, getPathFrom(ag3)).
+top(X,Y,ag1) : seenGoal(X2,Y2, goal1) & not givenPathToGoal(goal1) <- .send(ag1,unachieve,explore); .send(ag1, tell, getPathFrom(ag3)).
+down(X,Y,ag1) : seenGoal(X2,Y2, goal1) & not givenPathToGoal(goal1) <- .send(ag1,unachieve,explore); .send(ag1, tell, getPathFrom(ag3)).

+left(X,Y,ag2) : seenGoal(X2,Y2, goal2) & not givenPathToGoal(goal2) <- .send(ag2,unachieve,explore); .send(ag2, tell, getPathFrom(ag3)).
+right(X,Y,ag2) : seenGoal(X2,Y2, goal2) & not givenPathToGoal(goal2) <- .send(ag2,unachieve,explore); .send(ag2, tell, getPathFrom(ag3)).
+top(X,Y,ag2) : seenGoal(X2,Y2, goal2) & not givenPathToGoal(goal2) <- .send(ag2,unachieve,explore); .send(ag2, tell, getPathFrom(ag3)).
+down(X,Y,ag2) : seenGoal(X2,Y2, goal2) & not givenPathToGoal(goal2) <- .send(ag2,unachieve,explore); .send(ag2, tell, getPathFrom(ag3)).
...
+!followPathToGoal : at(X,Y,goal3) <- pickup(X,Y); !returnToStart.
