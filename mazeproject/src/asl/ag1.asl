...
/* Plans */
+!explore : at(X,Y,goal1) <- pickup(X,Y); !returnToStart.

+!explore : left(X,Y,goal1) <- move(X,Y); !explore.
+!explore : right(X,Y,goal1) <- move(X,Y); !explore.
+!explore : top(X,Y,goal1) <- move(X,Y); !explore.
+!explore : down(X,Y,goal1) <- move(X,Y); !explore.
...
+!moveOver: at(X,Y,start) & top(X2,Y2,start) <-.print("I should probably move"); move(X2,Y2); .print("I moved!").
+!moveOver: at(X,Y,start) & left(X2,Y2,start) <- .print("I should probably move"); move(X2,Y2); .print("I moved!").
+!moveOver: at(X,Y,start) & right(X2,Y2,start) <- .print("I should probably move"); move(X2,Y2); .print("I moved!").
+!moveOver: at(X,Y,start) & down(X2,Y2,start) <-.print("I should probably move"); move(X2,Y2); .print("I moved!").
...
+left(X,Y,ag0) : seenGoal(X2,Y2, goal0) & not givenPathToGoal(goal0) <- .send(ag0,unachieve,explore); .send(ag0, tell, getPathFrom(ag1)).
+right(X,Y,ag0) : seenGoal(X2,Y2, goal0) & not givenPathToGoal(goal0) <-.send(ag0,unachieve,explore); .send(ag0, tell, getPathFrom(ag1)).
+top(X,Y,ag0) : seenGoal(X2,Y2, goal0) & not givenPathToGoal(goal0) <- .send(ag0,unachieve,explore); .send(ag0, tell, getPathFrom(ag1)).
+down(X,Y,ag0) : seenGoal(X2,Y2, goal0) & not givenPathToGoal(goal0) <- .send(ag0,unachieve,explore); .send(ag0, tell, getPathFrom(ag1)).

+left(X,Y,ag2) : seenGoal(X2,Y2, goal2) & not givenPathToGoal(goal2) <- .send(ag2,unachieve,explore); .send(ag2, tell, getPathFrom(ag1)).
+right(X,Y,ag2) : seenGoal(X2,Y2, goal2) & not givenPathToGoal(goal2) <- .send(ag2,unachieve,explore); .send(ag2, tell, getPathFrom(ag1)).
+top(X,Y,ag2) : seenGoal(X2,Y2, goal2) & not givenPathToGoal(goal2) <- .send(ag2,unachieve,explore); .send(ag2, tell, getPathFrom(ag1)).
+down(X,Y,ag2) : seenGoal(X2,Y2, goal2) & not givenPathToGoal(goal2) <- .send(ag2,unachieve,explore); .send(ag2, tell, getPathFrom(ag1)).

+left(X,Y,ag3) : seenGoal(X2,Y2, goal3) & not givenPathToGoal(goal3) <- .send(ag3,unachieve,explore); .send(ag3, tell, getPathFrom(ag1)).
+right(X,Y,ag3) : seenGoal(X2,Y2, goal3) & not givenPathToGoal(goal3) <- .send(ag3,unachieve,explore); .send(ag3, tell, getPathFrom(ag1)).
+top(X,Y,ag3) : seenGoal(X2,Y2, goal3) & not givenPathToGoal(goal3) <- .send(ag3,unachieve,explore); .send(ag3, tell, getPathFrom(ag1)).
+down(X,Y,ag3) : seenGoal(X2,Y2, goal3) & not givenPathToGoal(goal3) <- .send(ag3,unachieve,explore); .send(ag3, tell, getPathFrom(ag1)).
...
+!followPathToGoal : at(X,Y,goal1) <- pickup(X,Y); !returnToStart.
